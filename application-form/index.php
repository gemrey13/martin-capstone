...
<div class="form-container">
    ...
    <form action="./action.php" method="post" enctype="multipart/form-data" id="multiStepForm">
        ...
        <div class="form-step">
            ...
            <div class="d-flex justify-content-between mt-4">
                <button type="button" class="btn btn-secondary prev-btn">Previous</button>
                <button type="submit" id="submitApplicationBtn" class="btn btn-primary">Complete Registration</button>
            </div>
        </div>
