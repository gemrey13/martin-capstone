...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO organizations (name, address, contact_number, email, members, establishment_date, password)
            VALUES (:name, :address, :contact_number, :email, :members, :establishment_date, :password)";
